...
if(isset($_POST)) {
	...
	$sql = "INSERT INTO job_post(id_company, jobtitle, description, minimumsalary, maximumsalary, vacancy, qualification) VALUES ('$_SESSION[id_user]','$jobtitle', '$description', '$minimumsalary', '$maximumsalary', '$vacancy', '$qualification')";
