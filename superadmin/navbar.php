            ...
            <li class="nav-item">
                ...
                <div id="collapsethree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="colacolor py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Admin Operations:</h6>
                        <a class="collapse-item text-white" href="addadmin.php">Add Admin</a>
                        <a class="collapse-item text-white  text-white" href="manageadmin.php">Manage Admin</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
